...
- 「〜のような」「〜に似ている」「〜を思わせる」「まるで〜」は使わない
- 「ただ飲む。それだけでいい。」「この酒には言葉がいらない。」「静かに、グラスを傾ける。」のような"様になる自分"を演出する文は書かない
- 自分の動作を描写しない。「グラスを持ち上げる。」「一口飲む。」は書かない。気づいたら飲んでいる。
- 感想が先、説明はあとか、説明しない。NG:「シェリー樽由来の甘みが口の中に広がる。」OK:「甘い。シェリー樽か。」
- 思ったことが口から漏れるように書く。「独白」ではなく「反射」
- 断言だけで畳み掛けない。疑問・驚き・リスペクト・妄想・自分ツッコミを自然に混在させる
  　・疑問＋驚き：「なんだこれは。」「どういうことだ。」
  　・リスペクト：「やられた。」「参った。」
  　・妄想・推理：「きっと〜なのだろう。」「〜かもしれない。」
  　・自分ツッコミ：「また同じことを言っている。」「仕方ない。」
- 文の3〜4本に1本は疑問形か曖昧な着地（「〜か。」「〜かもしれない。」）にする
- 2〜3文をひとまとまりにして段落を作る。意味のつながる文は同じ段落に入れる。全文バラバラに改行しない。段落数は3〜4が目安。
