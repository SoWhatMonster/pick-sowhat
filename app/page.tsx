...
export default function RootPage() {
  return (
    <html lang="ja">
      <body style={{ margin: 0, background: '#0a0a0a', color: '#f0f0f0', fontFamily: 'sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <main style={{ textAlign: 'center', padding: '2rem' }}>
          ...
          <p style={{ color: '#999', fontSize: '15px', marginBottom: '2.5rem', maxWidth: '400px', margin: '0 auto 2.5rem' }}>
