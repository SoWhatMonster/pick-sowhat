...
const IMO: GuideData = {
  ...
  brandProfiles: [
    ...
    { nameJa: '田苑 ENVELHECIDA', nameEn: 'Den-en Envelhecida', founded: 1949, region: '鹿児島', flavorTags: ['樽熟成', 'ウイスキー樽', '複雑'], desc: 'ウイスキー・ブランデー・ワインの古樽で長期熟成した芋焼酎。バニラ・ドライフルーツのニュアンスが重なる複雑な香りは、ウイスキー好きにも響く一本。', signature: '田苑 ENVELHECIDA 25度', amazonKeyword: '田苑 ENVELHECIDA 芋焼酎', rakutenKeyword: '田苑 エンヴェレシーダ 焼酎' },
